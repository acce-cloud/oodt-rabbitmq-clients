...
class RabbitmqProducer(object):
    ...
    def __init__(self, workflow_event):
        ...
        url = os.environ.get('RABBITMQ_USER_URL',
    ...
    def produce(self, message):
        ...
        logging.critical("Sent workflow message %r: %r" %
    ...
    def wait_for_completion(self):
        ...
        num_msgs = -1
        while num_msgs != 0:
            num_msgs = self.channel.queue_declare(
                queue=self.queue_name, durable=True, passive=True).method.message_count
        ...
        while num_unack_messages != 0:
            ...
            logging.critical("Number of unack messages: %s" %
                             num_unack_messages)
            time.sleep(1)
